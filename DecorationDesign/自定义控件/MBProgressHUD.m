...
- (void)settext:(NSString *)text aftertime:(float)time
{
    if (text) {
...
+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated {
    ...
    [hud setLabelText:@"正在努力加载"];//数据加载中
    [hud setBackgroundColor:[UIColor clearColor]];
    UIView *backView = [[UIView alloc] initWithFrame:hud.frame];
    [hud setCustomView:backView];
    [backView release];
    [hud.customView setBackgroundColor:[UIColor blueColor]];
	[view addSubview:hud];
	[hud show:animated];
