...
@synthesize designerPicView,bookingLabel,boutiqueLabel,signedLabel,worksLabel;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        UILabel *title = [[UILabel alloc] initWithFrame:CGRectMake(96, 10, 150, 24)];
        ...
        UILabel *jingping = [[UILabel alloc] initWithFrame:CGRectMake(206, 36, 60, 18)];
        jingping.text = @"设计精品:";
        ...
        UILabel *yuyuecishu = [[UILabel alloc] initWithFrame:CGRectMake(96, 54, 60, 18)];
        yuyuecishu.text = @"预约次数:";
        ...
        [yuyuecishu release];
        UILabel *yuyuecishuValue = [[UILabel alloc] initWithFrame:CGRectMake(156, 54, 50, 18)];
        yuyuecishuValue.text = @"8";
